/**
 * \file param.c
 * \brief Gestion des paramètres du programme
 * \author Marc Blanc-Patin et Paul Bernier
 * \version 1.0.0
 * \date 16 avril 2011
 *
 * Récupère et analyse les paramètres du programme
 *
 */
...
int checkChar(char *string)
{
	...
	{
		if (strchr(CHAR_AUTH,string[i]) == 0) test = 0;
	}
	return test;
}
